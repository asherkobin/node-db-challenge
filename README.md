...
Relational Databases is the storage/layout of data, SQL is the language to communicate with those databases

- [ ] Why do tables need a `primary key`?

To uniquely identify a record/row.  It enables use of other features such as making relations between tables.
...
A relation or mapping table that has data consisting of the primary keys of each of the two tables.
